...
//    var appleX = appleY = 15;
    ...
    function game() {
        ...
        bloqueantes.forEach(function(bloq){
            ...
            context.fillRect(bloq.positionX3, bloq.positionY2, bloq.width, bloq.height2);         
        })
        ...
        while ((((bloqueantes.positionX1 == xAtual) || (bloqueantes.positionX2 == xAtual)) && ((yAtual >= bloqueantes.positionY1) && (yAtual <= (bloqueantes.positionY1 + bloqueantes.height1)))) ||
              ((bloqueantes.positionX3 == xAtual) && ((yAtual >= bloqueantes.positionY2) && (yAtual <= (bloqueantes.positionY2 + bloqueantes.height2)))))
        {
        ...
        bloqueantes.forEach(bloq => {
            ...
            if ((((bloq.positionX1 == xAtual) || (bloq.positionX2 == xAtual)) && ((yAtual >= bloq.positionY1) && (yAtual <= (bloq.positionY1 + bloq.height1 - 1)))) ||
               ((bloq.positionX3 == xAtual) && ((yAtual >= bloq.positionY2) && (yAtual <= (bloq.positionY2 + bloq.height2 - 1)))))
            {
                document.Frm1._vidas.value = Number(document.Frm1._vidas.value) - 1;                        
    ...
    function verificaseganhou(pontuacao) {
        if (pontuacao === 10) {
            ...
            document.Frm1.action = "game_fase5.html"
            document.getElementById("restarbtn").click()
            document.Frm1.submit()
        }
    }

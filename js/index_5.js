...
//    var appleX = appleY = 15;
    ...
    function game() {
        ...
        bloqueantes.forEach(function(bloq){
            context.fillStyle = "white";    
            context.fillRect(bloq.positionX1, bloq.positionY1, bloq.width, bloq.height1);
            context.fillRect(bloq.positionX2, bloq.positionY1, bloq.width, bloq.height1);  
            context.fillRect(bloq.positionX3, bloq.positionY2, bloq.width, bloq.height1);         
            context.fillRect(bloq.positionX4, bloq.positionY3, bloq.width2, bloq.height2);
            context.fillRect(bloq.positionX4, bloq.positionY4, bloq.width2, bloq.height2);
        })
        ...
        while ((((bloqueantes.positionX1 == xAtual) || (bloqueantes.positionX2 == xAtual) || (bloqueantes.positionX3 == xAtual)) && ((yAtual >= bloqueantes.positionY1) && (yAtual <= (bloqueantes.positionY1 + bloqueantes.height1)))) ||
              (((bloqueantes.positionY3 == yAtual) || (bloqueantes.positionY4 == yAtual)) && ((xAtual >= bloqueantes.positionX4) && (xAtual <= (bloqueantes.positionX4 + bloqueantes.width2)))))
        {
        ...
        bloqueantes.forEach(bloq => {
            ...
            if ((((bloq.positionX1 == xAtual) || (bloq.positionX2 == xAtual) || (bloq.positionX3 == xAtual)) && ((yAtual >= bloq.positionY1) && (yAtual <= (bloq.positionY1 + bloq.height1 - 1)))) ||
               (((bloq.positionY3 == yAtual) || (bloq.positionY4 == yAtual)) && ((xAtual >= bloq.positionX4) && (xAtual <= (bloq.positionX4 + bloq.width2 - 1)))))
            {
                document.Frm1._vidas.value = Number(document.Frm1._vidas.value) - 1;                        

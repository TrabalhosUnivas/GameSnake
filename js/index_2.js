...
//    var appleX = appleY = 15;
    ...
    function game() {
        ...
        bloqueantes.forEach(function(bloq){
            context.fillStyle = "white";
            context.fillRect(bloq.positionX, bloq.positionY, bloq.width, bloq.height);
        })
        ...
        while((bloqueantes.positionX == xAtual) && ((yAtual >= bloqueantes.positionY) && (yAtual <= (bloqueantes.positionY + bloqueantes.height))) )
        {
        ...
        bloqueantes.forEach(bloq => {
            ...
            if((bloq.positionX == xAtual) && ((yAtual >= bloq.positionY) && (yAtual <= (bloq.positionY + bloq.height - 1))) ){
                document.Frm1._vidas.value = Number(document.Frm1._vidas.value) - 1;                        
    ...
    function verificaseganhou(pontuacao) {
        if (pontuacao === 10) {
            ...
            document.Frm1.action = "game_fase3.html"
            document.getElementById("restarbtn").click()
            document.Frm1.submit()
        }
    }
